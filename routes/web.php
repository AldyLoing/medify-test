...
Route::get('/master-items/export-pdf', [App\Http\Controllers\MasterItemsController::class, 'exportPdf']);
Route::get('/master-items/pdf/{id}', [App\Http\Controllers\MasterItemsController::class, 'pdf']);
